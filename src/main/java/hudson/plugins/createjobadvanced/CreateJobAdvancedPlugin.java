...
public class CreateJobAdvancedPlugin extends Plugin {
  ...
  private List<DynamicPermissionConfig> dynamicPermissionConfigs =
      new ArrayList<DynamicPermissionConfig>();
  ...
  public void configure(StaplerRequest req, JSONObject formData)
    ...
    final JSONObject activeDynamicPermissionsJson =
        formData.optJSONObject("activeDynamicPermissions");
  ...
  private static void addEnabledPermissionsForGroup(final List<Permission> enabledPerms,
      Class<?> owner) {
